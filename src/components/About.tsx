...
const About = () => {
  ...
  const skills = [
    ...
    { category: "Technologies", items: ["TensorFlow", "PyTorch", "scikit-learn", "React"] },
    { category: "Soft Skills", items: ["Teamwork", "Leadership", "Problem Solving", "Event Coordination"] },
  ];

  return (
    <section id="about" className="py-20 bg-portfolio-card/30">
